...
SGPI_Lines sgpi_line_initial(SGPI_Lines input){
    ...
    input.angle = angle;
    GLboolean clockwise[] = {false,false};
...
PropertyLines sgpi_propertyLines_initial(PropertyLines appearance){
    appearance.lineWidth = line_width_table[0];
    appearance.lineStipple = line_stipple_table[0];
    appearance.lineCap = 1;
    appearance.haloing = true;
    appearance.haloColor = (Color){ 0, 0, 0, 255 };
    appearance.outlineColor = (Color){ 255, 255, 255, 255 };
...
PropertyArc sgpi_propertyArc_initial(PropertyArc appearance){
    ...
    appearance.outlineColor = (Color){ 255, 255, 255, 255 };
    appearance.outlineOpacity = 255;
    appearance.fillColor = (Color){ 0, 0, 0, 255 };
    appearance.fillOpacity = 255;
    appearance.polygonSmooth = true;
    Texture texture;
    texture.horizAlign = 0;
